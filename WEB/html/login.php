  ...
  <div class="background-image"></div>
    ...
    <div class="overlay-red">
        <div class="login-box">
          ...
          <p style="margin-top: 50px; align-self: end;">No tens conta? <a href="./register.php" style="text-decoration: underline; font-weight: bold; color: var(--agua-rgb);">Crea una</a></p>
        </div>
    </div>
