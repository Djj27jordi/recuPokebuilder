...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">  <link rel="stylesheet" href="../css/colors.css">
...
<body class="fons_barres">
  ...
  <div class="cont_blanc">
    ...
    <!-- <section>
      <div class="divBotoAleatori">
        <button class="botoAleatori" id="botoAleatori">Equip Aleatori</button>
      </div>
    </section> -->
    ...
    <section>
      <div class="equip">
        <ul class="llocsPkmn">
          <li class="equipPkmn" id="pkmn1">
            <img src="../../IMG/huevo.gif" class="imgPkmn" id="pkmn1" alt="">
          </li>
          <li class="equipPkmn" id="pkmn2">
            <img src="../../IMG/huevo.gif" class="imgPkmn" id="pkmn2" alt="">
          </li>
          <li class="equipPkmn" id="pkmn3">
            <img src="../../IMG/huevo.gif" class="imgPkmn" id="pkmn3" alt="">
          </li>
          <li class="equipPkmn" id="pkmn4">
            <img src="../../IMG/huevo.gif" class="imgPkmn" id="pkmn4" alt="">
          </li>
          <li class="equipPkmn" id="pkmn5">
            <img src="../../IMG/huevo.gif" class="imgPkmn" id="pkmn5" alt="">
          </li>
          <li class="equipPkmn" id="pkmn6">
            <img src="../../IMG/huevo.gif" class="imgPkmn" id="pkmn6" alt="">
          </li>
        </ul>
      </div>
    </section>
