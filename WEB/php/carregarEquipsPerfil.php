...
$sql = "SELECT eq.ID_equipsPokemon, pok1dex.imatgeM AS img1, pok2dex.imatgeM AS img2, pok3dex.imatgeM AS img3, pok4dex.imatgeM AS img4, pok5dex.imatgeM AS img5, pok6dex.imatgeM AS img6
        FROM equips_pokemon eq
        ...
        WHERE eq.fk_usuari = '$idUsuari'";

$imatgesPokemonEquip = [];

$execucio = mysqli_query($conn, $sql);

while ($fila = mysqli_fetch_assoc($execucio)) {
  $imatgesPokemonEquip[] = $fila;
}

echo json_encode($imatgesPokemonEquip);
?>